...
That command runs the Node tests and static review, rebuilds the ZIP, and then compares every archived file byte-for-byte with the reviewed `extension/` tree. It also verifies the ZIP path boundary, manifest, integrity, and SHA-256 sidecar.
