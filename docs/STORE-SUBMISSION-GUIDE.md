# Quiet Browse 0.5.2 — complete Chrome Web Store submission guide
...
- Store package: `dist/quiet-browse-0.5.2.zip`
- SHA-256: `c5ea313b1758717da052e7430c5bcf0e58a49c54d9b0036c031a6aded0ee85e8`
- Manifest V3, 21 packaged files, and no remote executable code
- 38 Node tests, 126 browser fixture checks, static checks, and ZIP integrity checks passed
...
3. From the project folder, initialize and push the prepared source:
   ...
   git branch -M main
   git add .
   git commit -m "Publish Quiet Browse 0.5.2"
...
- No feature shown unless it exists in version 0.5.2.
...
Upload it as **Unlisted** on YouTube. Title it `Quiet Browse 0.5.2 — Chrome extension demonstration`. In the description, state that it shows version 0.5.2 and contains no paid endorsement.
...
## Phase 8 — create the item and upload version 0.5.2

1. In the dashboard, choose **Add new item**.
2. Upload `dist/quiet-browse-0.5.2.zip`.
3. Confirm the dashboard identifies Manifest V3 and version 0.5.2.
...
2. Confirm the package, listing, privacy answers, website, screenshots, video, and reviewer instructions all describe version 0.5.2.
