...
5. **Marketing scope.** Advertise only implemented and verified behavior. The current package is a beta with local fixture tests and user testing, not proof of universal compatibility.
