...
5. **Marketing scope.** Advertise only implemented and verified behavior. Version 1.0.0 passed the documented automated checks and received publisher approval for its GitHub release; that is not proof of universal compatibility or Google approval.
...
Version 0.5.7 received Chrome Web Store review and is public. Version 1.0.0 is released on GitHub but has not yet received Chrome Web Store review; this engineering review is not legal sign-off or a guarantee of Google approval.
