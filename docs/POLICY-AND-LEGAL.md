...
5. **Marketing scope.** Advertise only implemented and verified behavior. Version 1.0.1 is published on GitHub, but automated checks are not proof of universal compatibility or Google approval; complete live checks and publisher review before Chrome Web Store submission.
...
Version 0.5.7 received Chrome Web Store review and is public. Version 1.0.1 is released on GitHub. This engineering review is not legal sign-off or a guarantee of Google approval.
