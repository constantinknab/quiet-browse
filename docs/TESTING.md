...
- `/demo/social-tests.html`: 22 checks covering Instagram route classification, independent Stories/follow-recommendation/Reels/Explore/home controls, the interaction between restored followed posts and still-hidden Stories/suggestions, local-time Stories scheduling, directly opened Story/Reel preservation, message/profile preservation, continuation-feed removal, notices, and complete undo.
